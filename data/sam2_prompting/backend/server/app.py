...
if __name__ == '__main__':
    ...
    parser.add_argument('--video_regex', default=None,
                        help='Regex to match full video_path strings')
    parser.add_argument(
        "--filter-for-testset",
        action="store_true",
        help=(
    ...
    if args.video_regex is not None:
        dataset_kwargs["video_regex"] = args.video_regex
    ...
    # C00015
    # pattern = '^.+/C00015_(?:deodrant|drinking|face wash|glasses)1_\d+\.mkv$'

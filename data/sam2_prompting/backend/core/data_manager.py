...
class DataManager:
    ...
    """
    def __init__(self, storage_path: str = DataPaths.HUMAN_INPUT_JSON_PATH,
    ...
    def _calculate_frames_needed(self):
        ...
        for data_item in self.dataset:
            path_v = os.path.join(DataPaths.RAW_VIDEO_DIR, data_item['path_v'])
            path_l = os.path.join(DataPaths.RAW_LABEL_DIR, data_item['path_l'])

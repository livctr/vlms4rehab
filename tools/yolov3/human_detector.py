...
from tools.yolov3.util import *
from tools.yolov3.darknet import Darknet
from tools.yolov3 import preprocess
...
def arg_parse():
    ...
    parser.add_argument('-wf', '--weight-file', type=str, default= 'tools/yolov3/checkpoint/yolov3.weights', help='The path'
